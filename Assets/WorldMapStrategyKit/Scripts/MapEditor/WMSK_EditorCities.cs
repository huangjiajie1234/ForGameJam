...
namespace WorldMapStrategyKit_Editor {
	...
	public partial class WMSK_Editor : MonoBehaviour {
		...
		public void CityCreate(Vector2 newPoint) {
			...
			City newCity = new City(GUICityName, provinceName, countryIndex, 100, newPoint, GUICityClass, map.GetUniqueId(new List<IExtendableAttribute>(map.cities.ToArray())));
